...
const StrepPament = () => {
    ...
    const makePayment = async()=>{
        ...
        const stripe = await loadStripe("pk_test_51OECgpLQtllTsrNN3z9oMc1sinyigIsmPI2djStljvr1iM9Ckur8hl5NsWAXb8zoebjbr7IBNTOMbafr0vPO31Dj00IonfgKbb");

        const body = {
            products:[
                {price:400, dish: "hair Staile", imgdata: "https://b.zmtcdn.com/data/pictures/9/18857339/8f53919f1175c08cf0f0371b73704f9b_o2_featured_v2.jpg?output-format=webp",},
                {price:600,dish: "color design",  imgdata: "https://b.zmtcdn.com/data/pictures/7/19639627/94c0a4cf15c02d3982d154e2c5dd8cbb_o2_featured_v2.jpg",},
                {price:100, dish: "hair color",  imgdata: "https://b.zmtcdn.com/data/pictures/3/18514413/0a17b72e9fec52a3ca736f4c2ea3646f_o2_featured_v2.jpg",},
                {price:2000,dish: "Body Teatment", imgdata: "https://b.zmtcdn.com/data/pictures/5/113895/3c06f6fbb8f667a2537dfdb6f060dc8b_o2_featured_v2.jpg",}
    ...
    return (
        <div>
           <button onClick={makePayment} className='btn btn-square bg-success'>payNow</button>
        </div>
    );
};

export default StrepPament;